...
function workscout_welcome_content() {
  ...
  <div class="wrap welcome-wrap">
    ...
    <h1>Welcome to WorkScout!</h1>
      ...
      <p> The WP Job Manager plugin and its add-ons are handled by <a href="https://wpjobmanager.com/support/">WPJM support</a>.</p>
