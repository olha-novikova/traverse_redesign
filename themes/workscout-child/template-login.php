			...
			if ( is_user_logged_in() ) { 
				...
				<div class="myaccount_user">
					...
					if ( in_array( 'candidate', (array) $user->roles ) || in_array( 'administrator', (array) $user->roles ) ) { 
						...
						printf( __( '<a href="%s" class="button margin-bottom-15"><i class="fa fa-user"></i> My Portfolios </a>', 'workscout' ),	get_permalink($candidate_dashboard_page_id));
					} 
					...
					if (in_array( 'employer', (array) $user->roles ) || in_array( 'administrator', (array) $user->roles ) ) { 
						...
						printf( __( '<a href="%s" class="button  margin-bottom-15"><i class="fa fa-user"></i> My Listings </a>', 'workscout' ), get_permalink($employer_dashboard_page_id) );
