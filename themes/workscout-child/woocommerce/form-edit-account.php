...
<?php $user = wp_get_current_user(); ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		...
		<input type="text" class="woocommerce-Input woocommerce-Input--email input-text" name="account_first_name" id="account_email" value="<?php echo esc_attr( $user->display_name  ); ?>" />
	</p>
