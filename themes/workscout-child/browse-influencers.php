        ...
        <section class="section section_panel">
            <div class="section__container">
                <div class="panel__influencers">
                    <p class="panel__influencers__text">Browse Influencers (<span class="panel__influencers__number">50,345<span>)</p>
                </div>
                <div class="panel__sort dropdown show">
                    ...
                    <div aria-labelledby="dropdownMenuLink" class="dropdown-menu"><a href="#" class="dropdown-item">Audience Size</a><a href="#" class="dropdown-item">Smth Else</a><a href="#" class="dropdown-item">Smth different</a></div>
                </div>
