<table class="job-manager-past-applications manage-table  responsive-table">
	<tr>
		...
		<th><?php _e( '', 'wp-job-manager-applications' ); ?></th>
	</tr>
	<?php foreach ( $applications as $application ) {
		...
		<tr>
			 ...
			 <td class="application-message">
               ...
               <?php if ( $job && $job->post_status == 'publish' ) { ?>
			 		<a href="<?php echo esc_url( get_permalink( $job_id ) ); ?>">View</a>
			 	<?php } else {
			 		echo "View";
			 	} ?>
			 </td>
