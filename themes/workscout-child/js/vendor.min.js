if (!function (e, t) {
        ...
        function g(e, t, n, i) {
            var o, r = 1, s = 20, a = i ? function () {
                ...
                u = (ge.cssNumber[t] || "px" !== c && +l) && Fe.exec(ge.css(e, t));
            if (u && u[3] !== c) {
                c = c || u[3], n = n || [], u = +l || 1;
        ...
        function v(e, t) {
            for (var n, i, o = [], r = 0, s = e.length; r < s; r++) i = e[r], i.style && (n = i.style.display, t ? ("none" === n && (o[r] = $e.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && qe(i) && (o[r] = m(i))) : "none" !== n && (o[r] = "none", $e.set(i, "display", n)));
        ...
        function b(e, t, n, i, o) {
            for (var r, s, a, l, c, u, d = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++) if (r = e[f], r || 0 === r) if ("object" === ge.type(r)) ge.merge(p, r.nodeType ? [r] : r); else if (Ye.test(r)) {
                for (s = s || d.appendChild(t.createElement("div")), a = (Ge.exec(r) || ["", ""])[1].toLowerCase(), l = Ke[a] || Ke._default, s.innerHTML = l[1] + ge.htmlPrefilter(r) + l[2], u = l[0]; u--;) s = s.lastChild;
                ge.merge(p, s.childNodes), s = d.firstChild, s.textContent = ""
            } else p.push(t.createTextNode(r));
            for (d.textContent = "", f = 0; r = p[f++];) if (i && ge.inArray(r, i) > -1) o && o.push(r); else if (c = ge.contains(r.ownerDocument, r), s = y(d.appendChild(r), "script"), c && T(s), n) for (u = 0; r = s[u++];) Qe.test(r.type || "") && n.push(r);
            return d
        }
        ...
        function D(e, t, i, o) {
            t = re.apply([], t);
            var r, s, a, l, c, u, d = 0, p = e.length, f = p - 1, h = t[0], g = ge.isFunction(h);
            ...
            if (p && (r = b(t, e[0].ownerDocument, !1, e, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), s || o)) {
                for (a = ge.map(y(r, "script"), x), l = a.length; d < p; d++) c = r, d !== f && (c = ge.clone(c, !0, !0), l && ge.merge(a, y(c, "script"))), i.call(e[d], c, d);
                if (l) for (u = a[a.length - 1].ownerDocument, ge.map(a, k), d = 0; d < l; d++) c = a[d], Qe.test(c.type || "") && !$e.access(c, "globalEval") && ge.contains(u, c) && (c.src ? ge._evalUrl && ge._evalUrl(c.src) : n(c.textContent.replace(rt, ""), u))
            }
            return e
        }
        ...
        function j(e, t, n, i, o) {
            var r, s = 0;
            for (r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; r < 4; r += 2) "margin" === n && (s += ge.css(e, n + Ue[r], !0, o)), i ? ("content" === n && (s -= ge.css(e, "padding" + Ue[r], !0, o)), "margin" !== n && (s -= ge.css(e, "border" + Ue[r] + "Width", !0, o))) : (s += ge.css(e, "padding" + Ue[r], !0, o), "padding" !== n && (s += ge.css(e, "border" + Ue[r] + "Width", !0, o)));
            return s
        }
        ...
        function M() {
            mt && (ne.hidden === !1 && e.requestAnimationFrame ? e.requestAnimationFrame(M) : e.setTimeout(M, ge.fx.interval), ge.fx.tick())
        }
        ...
        function B(e, t, n) {
            ...
            if (l = !ge.isEmptyObject(t), l || !ge.isEmptyObject(f)) {
                d && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], c = m && m.display, null == c && (c = $e.get(e, "display")), u = ge.css(e, "display"), "none" === u && (c ? u = c : (v([e], !0), c = e.style.display || c, u = ge.css(e, "display"), v([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === ge.css(e, "float") && (l || (p.done(function () {
                    h.display = c
                }), null == c && (u = h.display, c = "none" === u ? "" : u)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function () {
                    h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                })), l = !1;
                for (i in f) l || (m ? "hidden" in m && (g = m.hidden) : m = $e.access(e, "fxshow", {display: c}), r && (m.hidden = !g), g && v([e], !0), p.done(function () {
        ...
        function z(e, t, n) {
            ...
            for (V(u, c.opts.specialEasing); r < s; r++) if (i = z.prefilters[r].call(c, e, u, c.opts)) return ge.isFunction(i.stop) && (ge._queueHooks(c.elem, c.opts.queue).stop = ge.proxy(i.stop, i)), i;
            return ge.map(u, q, c), ge.isFunction(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), ge.fx.timer(ge.extend(l, {
                elem: e,
                anim: c,
                queue: c.opts.queue
            })), c
        ...
        var te = [], ne = e.document, ie = Object.getPrototypeOf, oe = te.slice, re = te.concat, se = te.push,
            ae = te.indexOf, le = {}, ce = le.toString, ue = le.hasOwnProperty, de = ue.toString, pe = de.call(Object),
        ...
        var be = function (e) {
                ...
                if (!i && ((t ? t.ownerDocument || t : F) !== L && N(t), t = t || L, H)) {
                    ...
                    if (_.qsa && !z[e + " "] && (!$ || !$.test(e))) {
                        if (1 !== h) p = t, u = e; else if ("object" !== t.nodeName.toLowerCase()) {
                            for ((a = t.getAttribute("id")) ? a = a.replace(we, _e) : t.setAttribute("id", a = M), c = x(e), r = c.length; r--;) c[r] = "#" + a + " " + f(c[r]);
            ...
            function h(e, t, n) {
                ...
                return t.first ? function (t, n, o) {
                    ...
                    } else for (; t = t[i];) if (1 === t.nodeType || s) if (d = t[M] || (t[M] = {}), u = d[t.uniqueID] || (d[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[i] || t; else {
            ...
            function y(e, t, n, o, r, s) {
                return o && !o[M] && (o = y(o)), r && !r[M] && (r = y(r, s)), i(function (i, s, a, l) {
                    var c, u, d, p = [], f = [], h = s.length, g = i || m(t || "*", a.nodeType ? [a] : a, []),
                        y = !e || !i && t ? g : v(g, p, e, a, l), T = n ? r || (i ? e : h || o) ? [] : s : y;
                    if (n && n(y, T, a, l), o) for (c = v(T, f), o(c, [], a, l), u = c.length; u--;) (d = c[u]) && (T[f[u]] = !(y[f[u]] = d));
                    if (i) {
                        if (r || e) {
                            if (r) {
                                for (c = [], u = T.length; u--;) (d = T[u]) && c.push(y[u] = d);
                                r(null, T = [], c, l)
                            }
                            for (u = T.length; u--;) (d = T[u]) && (c = r ? ee(i, d) : p[u]) > -1 && (i[c] = !(s[c] = d))
                        }
            ...
            function T(e) {
                for (var t, n, i, o = e.length, r = C.relative[e[0].type], s = r || C.relative[" "], a = r ? 1 : 0, l = h(function (e) {
                    ...
                    return t = null, o
                }]; a < o; a++) if (n = C.relative[e[a].type]) u = [h(g(u), n)]; else {
                    if (n = C.filter[e[a].type].apply(null, e[a].matches), n[M]) {
                        for (i = ++a; i < o && !C.relative[e[i].type]; i++) ;
                        return y(a > 1 && g(u), a > 1 && f(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(ae, "$1"), n, a < i && T(e.slice(a, i)), i < o && T(e = e.slice(i)), i < o && f(e))
                    }
                    u.push(n)
                }
                return g(u)
            ...
            function b(e, n) {
                var o = n.length > 0, r = e.length > 0, s = function (i, s, a, l, c) {
                    var u, d, p, f = 0, h = "0", g = i && [], m = [], y = O, T = i || r && C.find.TAG("*", c),
                        b = U += null == y ? 1 : Math.random() || .1, w = T.length;
                    for (c && (O = s === L || s || c); h !== w && null != (u = T[h]); h++) {
                        if (r && u) {
                            for (d = 0, s || u.ownerDocument === L || (N(u), a = !H); p = e[d++];) if (p(u, s || L, a)) {
                                l.push(u);
                                break
                            }
                            c && (U = b)
                    ...
                    if (f += h, o && h !== f) {
                        ...
                        if (i) {
                            if (f > 0) for (; h--;) g[h] || m[h] || (m[h] = Y.call(l));
                            m = v(m)
                        }
            ...
            var w, _, C, E, S, x, k, A, O, D, I, N, L, P, H, $, j, R, W, M = "sizzle" + 1 * new Date, F = e.document,
                U = 0, q = 0, B = n(), V = n(), z = n(), G = function (e, t) {
                    return e === t && (I = !0), 0
                }, Q = {}.hasOwnProperty, K = [], Y = K.pop, X = K.push, J = K.push, Z = K.slice, ee = function (e, t) {
            ...
            _ = t.support = {}, S = t.isXML = function (e) {
                ...
                return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, P = L.documentElement, H = !S(L), F !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), _.attributes = o(function (e) {
                ...
                }, j = [], $ = [], (_.qsa = me.test(L.querySelectorAll)) && (o(function (e) {
                ...
                }), $ = $.length && new RegExp($.join("|")), j = j.length && new RegExp(j.join("|")), t = me.test(P.compareDocumentPosition), W = t || me.test(P.contains) ? function (e, t) {
                    ...
                    return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !_.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === F && W(F, e) ? -1 : t === L || t.ownerDocument === F && W(F, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return I = !0, 0;
                ...
                if ((e.ownerDocument || e) !== L && N(e), n = n.replace(ue, "='$1']"), _.matchesSelector && H && !z[n + " "] && (!j || !j.test(n)) && (!$ || !$.test(n))) try {
                    var i = R.call(e, n);
                ...
                return (e.ownerDocument || e) !== L && N(e), W(e, t)
            }, t.attr = function (e, t) {
                (e.ownerDocument || e) !== L && N(e);
                var n = C.attrHandle[t.toLowerCase()],
                    i = n && Q.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0;
                ...
                var t, n = [], i = 0, o = 0;
                if (I = !_.detectDuplicates, D = !_.sortStable && e.slice(0), e.sort(G), I) {
                ...
                preFilter: {
                    ATTR: function (e) {
                        ...
                        var t, n = !e[6] && e[2];
                        return fe.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && de.test(n) && (t = x(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function (e) {
                        ...
                        return 1 === i && 0 === o ? function (e) {
                            ...
                            if (m) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (p = m, d = p[M] || (p[M] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], f = c[0] === U && c[1], T = f && c[2], p = f && m.childNodes[f]; p = ++f && p && p[g] || (T = f = 0) || h.pop();) if (1 === p.nodeType && ++T && p === t) {
                                        u[e] = [U, f, T];
                                        break
                                    }
                                } else if (y && (p = t, d = p[M] || (p[M] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], f = c[0] === U && c[1], T = f), T === !1) for (; (p = ++f && p && p[g] || (T = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++T || (y && (d = p[M] || (p[M] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), u[e] = [U, T]), p !== t));) ;
            ...
            return p.prototype = C.filters = C.pseudos, C.setFilters = new p, x = t.tokenize = function (e, n) {
                ...
                var n, i = [], o = [], r = z[e + " "];
                if (!r) {
                    for (t || (t = x(e)), n = t.length; n--;) r = T(t[n]), r[M] ? i.push(r) : o.push(r);
                    r = z(e, b(o, i)), r.selector = e
                }
                return r
            }, A = t.select = function (e, t, n, i) {
                var o, r, s, a, l, c = "function" == typeof e && e, u = !i && x(e = c.selector || e);
                if (n = n || [], 1 === u.length) {
                    if (r = u[0] = u[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && 9 === t.nodeType && H && C.relative[r[1].type]) {
                        if (t = (C.find.ID(s.matches[0].replace(Te, be), t) || [])[0], !t) return n;
                        c && (t = t.parentNode), e = e.slice(r.shift().value.length)
                    }
                    for (o = fe.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !C.relative[a = s.type]);) if ((l = C.find[a]) && (i = l(s.matches[0].replace(Te, be), ye.test(r[0].type) && d(t.parentNode) || t))) {
                        if (r.splice(o, 1), e = i.length && f(r), !e) return J.apply(n, i), n;
                        break
                    }
                }
                return (c || k(e, u))(i, t, !H, n, !t || ye.test(e) && d(t.parentNode) || t), n
            }, _.sortStable = M.split("").sort(G).join("") === M, _.detectDuplicates = !!I, N(), _.sortDetached = o(function (e) {
        ...
        ge.fn.extend({
            ...
            ge.fn[e] = function (n, i) {
                ...
                return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = ge.filter(i, o)), this.length > 1 && (De[e] || ge.uniqueSort(o), Oe.test(e) && o.reverse()), this.pushStack(o)
            }
        });
        var Ie = /[^\x20\t\r\n\f]+/g;
        ge.Callbacks = function (e) {
            ...
            Deferred: function (t) {
                ...
                var t = arguments.length, n = t, i = Array(n), o = oe.call(arguments), r = ge.Deferred(),
                    s = function (e) {
                        return function (n) {
        ...
        }), ge.ready.then = Le.then, "complete" === ne.readyState || "loading" !== ne.readyState && !ne.documentElement.doScroll ? e.setTimeout(ge.ready) : (ne.addEventListener("DOMContentLoaded", d), e.addEventListener("load", d));
        ...
        var $e = new p, je = new p, Re = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, We = /[A-Z]/g;
        ge.extend({
            hasData: function (e) {
                return je.hasData(e) || $e.hasData(e)
            }, data: function (e, t, n) {
            ...
            data: function (e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && (o = je.get(r), 1 === r.nodeType && !$e.get(r, "hasDataAttrs"))) {
            ...
            queue: function (e, t, n) {
                var i;
                if (e) return t = (t || "fx") + "queue", i = $e.get(e, t), n && (!i || Array.isArray(n) ? i = $e.access(e, t, ge.makeArray(n)) : i.push(n)), i || []
        ...
        var Me = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            Fe = new RegExp("^(?:([+-])=|)(" + Me + ")([a-z%]*)$", "i"), Ue = ["Top", "Right", "Bottom", "Left"],
            qe = function (e, t) {
        ...
        ge.event = {
            global: {}, add: function (e, t, n, i, o) {
                ...
                if (m) for (n.handler && (r = n, n = r.handler, o = r.selector), o && ge.find.matchesSelector(Xe, o), n.guid || (n.guid = ge.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
                    return "undefined" != typeof ge && ge.event.triggered !== t.type ? ge.event.dispatch.apply(e, arguments) : void 0
                }), t = (t || "").match(Ie) || [""], c = t.length; c--;) a = et.exec(t[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (d = ge.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, d = ge.event.special[f] || {}, u = ge.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
                ...
                if (m && (l = m.events)) {
                    ...
                    ge.isEmptyObject(l) && $e.remove(e, "handle events")
                }
            }, dispatch: function (e) {
                var t, n, i, o, r, s, a = ge.event.fix(e), l = new Array(arguments.length),
                    c = ($e.get(this, "events") || {})[a.type] || [], u = ge.event.special[a.type] || {};
        ...
        ge.extend({
            htmlPrefilter: function (e) {
                ...
                if (!(fe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ge.isXMLDoc(e))) for (s = y(a), r = y(e), i = 0, o = r.length; i < o; i++) O(r[i], s[i]);
                ...
                for (var t, n, i, o = ge.event.special, r = 0; void 0 !== (n = e[r]); r++) if (He(n)) {
                    if (t = n[$e.expando]) {
        ...
        var st = /^margin/, at = new RegExp("^(" + Me + ")(?!px)[a-z%]+$", "i"), lt = function (t) {
        ...
        var ct = /^(none|table(?!-c[ea]).+)/, ut = /^--/,
            ...
            pt = {letterSpacing: "0", fontWeight: "400"}, ft = ["Webkit", "Moz", "ms"],
        ...
        ge.extend({
            ...
            css: function (e, t, n, i) {
                ...
                return l || (t = H(a)), s = ge.cssHooks[t] || ge.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = N(e, t, i)), "normal" === o && t in pt && (o = pt[t]), "" === n || n ? (r = parseFloat(o), n === !0 || isFinite(r) ? r || 0 : o) : o
            }
        }), ge.each(["height", "width"], function (e, t) {
            ge.cssHooks[t] = {
                get: function (e, n, i) {
                    if (n) return !ct.test(ge.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? R(e, t, i) : Be(e, dt, function () {
                        return R(e, t, i)
                    })
                }, set: function (e, n, i) {
                    var o, r = i && lt(e), s = i && j(e, t, i, "border-box" === ge.css(e, "boxSizing", !1, r), r);
                    return s && (o = Fe.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = ge.css(e, t)), $(e, n, s)
                }
            }
        ...
        ge.Animation = ge.extend(z, {
            ...
            fadeTo: function (e, t, n, i) {
                ...
                return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                    var t = !0, o = null != e && e + "queueHooks", r = ge.timers, s = $e.get(this);
                ...
                return e !== !1 && (e = e || "fx"), this.each(function () {
                    var t, n = $e.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = ge.timers,
                        s = i ? i.length : 0;
        ...
        ge.fn.extend({
            ...
            addClass: function (e) {
                ...
                return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : ge.isFunction(e) ? this.each(function (n) {
                    ...
                    var t, i, o, r;
                    if ("string" === n) for (i = 0, o = ge(this), r = e.match(Ie) || []; t = r[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || (t = Q(this), t && $e.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : $e.get(this, "__className__") || ""))
                })
            }, hasClass: function (e) {
                var t, n, i = 0;
        ...
        ge.extend(ge.event, {
            trigger: function (t, n, i, o) {
                var r, s, a, l, c, u, d, p = [i || ne], f = ue.call(t, "type") ? t.type : t,
                    h = ue.call(t, "namespace") ? t.namespace.split(".") : [];
                if (s = a = i = i || ne, 3 !== i.nodeType && 8 !== i.nodeType && !Et.test(f + ge.event.triggered) && (f.indexOf(".") > -1 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, t = t[ge.expando] ? t : new ge.Event(f, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : ge.makeArray(n, [t]), d = ge.event.special[f] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                    if (!o && !d.noBubble && !ge.isWindow(i)) {
                        for (l = d.delegateType || f, Et.test(l + f) || (s = s.parentNode); s; s = s.parentNode) p.push(s), a = s;
                        a === (i.ownerDocument || ne) && p.push(a.defaultView || a.parentWindow || e)
                    }
                    for (r = 0; (s = p[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : d.bindType || f, u = ($e.get(s, "events") || {})[t.type] && $e.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && He(s) && (t.result = u.apply(s, n), t.result === !1 && t.preventDefault());
                    return t.type = f, o || t.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !He(i) || c && ge.isFunction(i[f]) && !ge.isWindow(i) && (a = i[c], a && (i[c] = null), ge.event.triggered = f, i[f](), ge.event.triggered = void 0, a && (i[c] = a)), t.result
                }
        ...
        var St = e.location, xt = ge.now(), kt = /\?/;
        ...
        ge.param = function (e, t) {
            ...
            serialize: function () {
                ...
                return this.map(function () {
                    ...
                    var e = this.type;
                    return this.name && !ge(this).is(":disabled") && It.test(this.nodeName) && !Dt.test(e) && (this.checked || !ze.test(e))
                }).map(function (e, t) {
                    var n = ge(this).val();
        ...
        var Nt = /%20/g, Lt = /#.*$/, Pt = /([?&])_=[^&]*/, Ht = /^(.*?):[ \t]*([^\r\n]*)$/gm,
            $t = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, jt = /^(?:GET|HEAD)$/, Rt = /^\/\//,
            Wt = {}, Mt = {}, Ft = "*/".concat("*"), Ut = ne.createElement("a");
        Ut.href = St.href, ge.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            ajax: function (t, n) {
                function i(t, n, i, a) {
                    var c, p, f, b, w, _ = n;
                    u || (u = !0, l && e.clearTimeout(l), o = void 0, s = a || "", C.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (b = Z(h, C, i)), b = ee(h, b, C, c), c ? (h.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (ge.lastModified[r] = w), w = C.getResponseHeader("etag"), w && (ge.etag[r] = w)), 204 === t || "HEAD" === h.type ? _ = "nocontent" : 304 === t ? _ = "notmodified" : (_ = b.state, p = b.data, f = b.error, c = !f)) : (f = _, !t && _ || (_ = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || _) + "", c ? v.resolveWith(g, [p, _, C]) : v.rejectWith(g, [C, _, f]), C.statusCode(T), T = void 0, d && m.trigger(c ? "ajaxSuccess" : "ajaxError", [C, h, c ? p : f]), y.fireWith(g, [C, _]), d && (m.trigger("ajaxComplete", [C, h]), --ge.active || ge.event.trigger("ajaxStop")))
                }

                "object" == typeof t && (n = t, t = void 0), n = n || {};
                var o, r, s, a, l, c, u, d, p, f, h = ge.ajaxSetup({}, n), g = h.context || h,
                    ...
                    y = ge.Callbacks("once memory"), T = h.statusCode || {}, b = {}, w = {}, _ = "canceled", C = {
                        readyState: 0, getResponseHeader: function (e) {
                            ...
                            var t;
                            if (e) if (u) C.always(e[C.status]); else for (t in e) T[t] = [T[t], e[t]];
                            return this
                        }, abort: function (e) {
                            var t = e || _;
                ...
                if (v.promise(C), h.url = ((t || h.url || St.href) + "").replace(Rt, St.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Ie) || [""], null == h.crossDomain) {
        ...
        var qt = {0: 200, 1223: 204}, Bt = ge.ajaxSettings.xhr();
        ...
        ge.ajaxSetup({
            ...
            var i, o, r;
            return t || (fe.createHTMLDocument ? (t = ne.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = ne.location.href, t.head.appendChild(i)) : t = ne), o = Ee.exec(e), r = !n && [], o ? [t.createElement(o[1])] : (o = b([e], t, r), r && r.length && ge(r).remove(), ge.merge([], o.childNodes))
            ...
            setOffset: function (e, t, n) {
                var i, o, r, s, a, l, c, u = ge.css(e, "position"), d = ge(e), p = {};
        ...
        function l(e) {
            ...
            if ("BODY" === i || "HTML" === i) {
                var o = window.document.documentElement, r = window.document.scrollingElement || o;
                return r[n]
            }
            return e[n]
        }
        ...
        function d(e, t, n, i) {
            return Q(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], oe() ? n["offset" + e] + i["margin" + ("Height" === e ? "Top" : "Left")] + i["margin" + ("Height" === e ? "Bottom" : "Right")] : 0)
        }

        function p() {
            var e = window.document.body, t = window.document.documentElement, n = oe() && window.getComputedStyle(t);
        ...
        function g(e, n) {
            var o = oe(), r = "HTML" === n.nodeName, s = h(e), a = h(n), l = i(e), u = t(n),
            ...
            return (o ? n.contains(l) : n === l && "BODY" !== l.nodeName) && (g = c(g, n)), g
        }

        function m(e) {
            var t = window.document.documentElement, n = g(e, t), i = Q(t.clientWidth, window.innerWidth || 0),
                o = Q(t.clientHeight, window.innerHeight || 0), r = l(t), s = l(t, "left"),
                a = {top: r - n.top + n.marginTop, left: s - n.left + n.marginLeft, width: i, height: o};
            return f(a)
        }
        ...
        function b(e, t, n, i, o) {
            ...
            var s = y(n, i, r, o), a = {
                ...
                return le({key: e}, a[e], {area: T(a[e])})
            }).sort(function (e, t) {
        ...
        function k(t, n, i) {
            var o = void 0 === i ? t : t.slice(0, x(t, "name", i));
        ...
        function A() {
            if (!this.state.isDestroyed) {
                ...
                e.offsets.reference = w(this.state, this.popper, this.reference), e.placement = b(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.offsets.popper = E(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = "absolute", e = k(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
            }
        }
        ...
        function R(e, t) {
            Object.keys(t).forEach(function (n) {
                var i = "";
                -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && j(t[n]) && (i = "px"), e.style[n] = t[n] + i
            })
        }
        ...
        function U(e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], n = ue.indexOf(e),
        ...
        function q(e, t, n, i) {
            ...
            if ("vh" === s || "vw" === s) {
                var c;
                return c = "vh" === s ? Q(document.documentElement.clientHeight, window.innerHeight || 0) : Q(document.documentElement.clientWidth, window.innerWidth || 0), c / 100 * r
            }
            return r
        }
        ...
        function V(e, t) {
            var n, i = t.offset, o = e.placement, r = e.offsets, s = r.popper, a = r.reference, l = o.split("-")[0];
            return n = j(+i) ? [+i, 0] : B(i, s, a, l), "left" === l ? (s.top += n[0], s.left -= n[1]) : "right" === l ? (s.top += n[0], s.left += n[1]) : "top" === l ? (s.left += n[0], s.top -= n[1]) : "bottom" === l && (s.left += n[0], s.top += n[1]), e.popper = s, e
        }

        for (var z = Math.min, G = Math.floor, Q = Math.max, K = ["native code", "[object MutationObserverConstructor]"], Y = function (e) {
            return K.some(function (t) {
                return -1 < (e || "").toString().indexOf(t)
            })
        }, X = "undefined" != typeof window, J = ["Edge", "Trident", "Firefox"], Z = 0, ee = 0; ee < J.length; ee += 1) if (X && 0 <= navigator.userAgent.indexOf(J[ee])) {
            Z = 1;
            break
        }
        var te, ne = X && Y(window.MutationObserver), ie = ne ? function (e) {
                var t = !1, n = 0, i = document.createElement("span"), o = new MutationObserver(function () {
                    e(), t = !1
                });
                return o.observe(i, {attributes: !0}), function () {
            ...
            ue = ce.slice(3), de = {FLIP: "flip", CLOCKWISE: "clockwise", COUNTERCLOCKWISE: "counterclockwise"},
            pe = function () {
                function t(n, i) {
                    ...
                    re(this, t), this.scheduleUpdate = function () {
                        ...
                        return le({name: e}, o.options.modifiers[e])
                    }).sort(function (e, t) {
            ...
            modifiers: {
                    ...
                    order: 100, enabled: !0, fn: function (e) {
                        ...
                        if (i) {
                            var o = e.offsets, r = o.reference, s = o.popper, a = -1 !== ["bottom", "top"].indexOf(n),
                                ...
                                u = {start: ae({}, l, r[l]), end: ae({}, l, r[l] + r[c] - s[c])};
                ...
                preventOverflow: {
                    order: 300, enabled: !0, fn: function (e, t) {
                        ...
                        var r = t.priority, s = e.offsets.popper, a = {
                            primary: function (e) {
                                var n = s[e];
                                return s[e] < i[e] && !t.escapeWithReference && (n = Q(s[e], i[e])), ae({}, e, n)
                            }, secondary: function (e) {
                                var n = "right" === e ? "left" : "top", o = s[n];
                                return s[e] > i[e] && !t.escapeWithReference && (o = z(s[n], i[e] - ("right" === e ? s.width : s.height))), ae({}, n, o)
                            }
                        };
                ...
                keepTogether: {
                    order: 400, enabled: !0, fn: function (e) {
                        var t = e.offsets, n = t.popper, i = t.reference, o = e.placement.split("-")[0], r = G,
                ...
                arrow: {
                    order: 500, enabled: !0, fn: function (e, n) {
                        ...
                        var o = e.placement.split("-")[0], r = e.offsets, s = r.popper, a = r.reference,
                            ...
                            d = u.toLowerCase(), p = l ? "left" : "top", h = l ? "bottom" : "right", g = _(i)[c];
                        a[h] - g < s[d] && (e.offsets.popper[d] -= s[d] - (a[h] - g)), a[d] + g > s[h] && (e.offsets.popper[d] += a[d] + g - s[h]);
                        var m = a[d] + a[c] / 2 - g / 2, v = t(e.instance.popper, "margin" + u).replace("px", ""),
                            y = m - f(e.offsets.popper)[d] - v;
                        return y = Q(z(s[c] - g, y), 0), e.arrowElement = i, e.offsets.arrow = {}, e.offsets.arrow[d] = Math.round(y), e.offsets.arrow[p] = "", e
                    }, element: "[x-arrow]"
                },
                flip: {
                    order: 600, enabled: !0, fn: function (e, t) {
                        ...
                        var n = y(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement),
                            i = e.placement.split("-")[0], o = C(i), r = e.placement.split("-")[1] || "", s = [];
                        switch (t.behavior) {
                            case de.FLIP:
                                s = [i, o];
                                break;
                        ...
                        return s.forEach(function (a, l) {
                            ...
                            var c = e.offsets.popper, u = e.offsets.reference, d = G,
                                p = "left" === i && d(c.right) > d(u.left) || "right" === i && d(c.left) < d(u.right) || "top" === i && d(c.bottom) > d(u.top) || "bottom" === i && d(c.top) < d(u.bottom),
                                f = d(c.left) < d(n.left), h = d(c.right) > d(n.right), g = d(c.top) < d(n.top),
                                m = d(c.bottom) > d(n.bottom),
                                v = "left" === i && f || "right" === i && h || "top" === i && g || "bottom" === i && m,
                                y = -1 !== ["top", "bottom"].indexOf(i),
                                T = !!t.flipVariations && (y && "start" === r && f || y && "end" === r && h || !y && "start" === r && g || !y && "end" === r && m);
                            (p || v || T) && (e.flipped = !0, (p || v) && (i = s[l + 1]), T && (r = F(r)), e.placement = i + (r ? "-" + r : ""), e.offsets.popper = le({}, e.offsets.popper, E(e.instance.popper, e.offsets.reference, e.placement)), e = k(e.instance.modifiers, e, "flip"))
                        }), e
                ...
                computeStyle: {
                    order: 850, enabled: !0, fn: function (e, t) {
                        var n = t.x, i = t.y, r = e.offsets.popper, s = S(e.instance.modifiers, function (e) {
                            return "applyStyle" === e.name
                        }).gpuAcceleration;
                        void 0 !== s && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                        var a, l, c = void 0 === s ? t.gpuAcceleration : s, u = o(e.instance.popper), d = h(u),
                            p = {position: r.position},
                            f = {left: G(r.left), top: G(r.top), bottom: G(r.bottom), right: G(r.right)},
                            g = "bottom" === n ? "top" : "bottom", m = "right" === i ? "left" : "right",
                            v = D("transform");
                        if (l = "bottom" == g ? -d.height + f.bottom : f.top, a = "right" == m ? -d.width + f.right : f.left, c && v) p[v] = "translate3d(" + a + "px, " + l + "px, 0)", p[g] = 0, p[m] = 0, p.willChange = "transform"; else {
                            var y = "bottom" == g ? -1 : 1, T = "right" == m ? -1 : 1;
                            p[g] = l * y, p[m] = a * T, p.willChange = g + ", " + m
                        }
                        var b = {"x-placement": e.placement};
                        return e.attributes = le({}, b, e.attributes), e.styles = le({}, p, e.styles), e.arrowStyles = le({}, e.offsets.arrow, e.arrowStyles), e
...
!function (e) {
    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        function o() {
            ...
            for (var t in c) if (void 0 !== e.style[t]) return {end: c[t]};
            return !1
        }
        ...
        var a = !1, l = 1e6, c = {
            ...
            TRANSITION_END: "bsTransitionEnd", getUID: function (e) {
                ...
                for (var r in o) if (o.hasOwnProperty(r)) {
                    var s = o[r], a = i[r], l = a && n(a) ? "element" : t(a);
        ...
        var t = "alert", i = "4.0.0-beta", s = "bs.alert", a = "." + s, l = ".data-api", c = e.fn[t], u = 150,
            ...
            f = {ALERT: "alert", FADE: "fade", SHOW: "show"}, h = function () {
                ...
                return t.prototype.close = function (e) {
                    ...
                    var n = this;
                    return e(t).removeClass(f.SHOW), r.supportsTransitionEnd() && e(t).hasClass(f.FADE) ? void e(t).one(r.TRANSITION_END, function (e) {
        ...
        return e(document).on(p.CLICK_DATA_API, d.DISMISS, h._handleDismiss(new h)), e.fn[t] = h._jQueryInterface, e.fn[t].Constructor = h, e.fn[t].noConflict = function () {
            return e.fn[t] = c, h._jQueryInterface
        }, h
    }(jQuery), function (e) {
        var t = "button", i = "4.0.0-beta", r = "bs.button", s = "." + r, a = ".data-api", l = e.fn[t],
            c = {ACTIVE: "active", BUTTON: "btn", FOCUS: "focus"}, u = {
                ...
                ACTIVE: ".active",
                BUTTON: ".btn"
            }, d = {CLICK_DATA_API: "click" + s + a, FOCUS_BLUR_DATA_API: "focus" + s + a + " " + ("blur" + s + a)},
            p = function () {
                function t(e) {
                    n(this, t), this._element = e
                }
                ...
                return t.prototype.toggle = function () {
                    var t = !0, n = !0, i = e(this._element).closest(u.DATA_TOGGLE)[0];
                    if (i) {
                        var o = e(this._element).find(u.INPUT)[0];
                        if (o) {
                            if ("radio" === o.type) if (o.checked && e(this._element).hasClass(c.ACTIVE)) t = !1; else {
                                var r = e(i).find(u.ACTIVE)[0];
                                r && e(r).removeClass(c.ACTIVE)
                            }
                            if (t) {
                                if (o.hasAttribute("disabled") || i.hasAttribute("disabled") || o.classList.contains("disabled") || i.classList.contains("disabled")) return;
                                o.checked = !e(this._element).hasClass(c.ACTIVE), e(o).trigger("change")
                            }
                            o.focus(), n = !1
                        }
                    }
        ...
        return e(document).on(d.CLICK_DATA_API, u.DATA_TOGGLE_CARROT, function (t) {
            t.preventDefault();
            var n = t.target;
            e(n).hasClass(c.BUTTON) || (n = e(n).closest(u.BUTTON)), p._jQueryInterface.call(e(n), "toggle")
        ...
        var t = "carousel", s = "4.0.0-beta", a = "bs.carousel", l = "." + a, c = ".data-api", u = e.fn[t], d = 600,
            p = 37, f = 39, h = 500, g = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0}, m = {
                interval: "(number|boolean)",
                keyboard: "boolean",
                slide: "(boolean|string)",
                pause: "(string|boolean)",
                wrap: "boolean"
            }, v = {NEXT: "next", PREV: "prev", LEFT: "left", RIGHT: "right"}, y = {
                SLIDE: "slide" + l,
                SLID: "slid" + l,
                KEYDOWN: "keydown" + l,
                ...
                function c(t, i) {
                    n(this, c), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(i), this._element = e(t)[0], this._indicatorsElement = e(this._element).find(b.INDICATORS)[0], this._addEventListeners()
                }
                ...
                return c.prototype.next = function () {
                    ...
                    this._isSliding || this._slide(v.PREV)
                    ...
                    return n = e.extend({}, g, n), r.typeCheckConfig(t, n, m), n
                    ...
                    this._config.keyboard && e(this._element).on(y.KEYDOWN, function (e) {
                        ...
                        return t.cycle(e)
                    }), "ontouchstart" in document.documentElement && e(this._element).on(y.TOUCHEND, function () {
                        t.pause(), t.touchTimeout && clearTimeout(t.touchTimeout), t.touchTimeout = setTimeout(function (e) {
                            return t.cycle(e)
                        }, h + t._config.interval)
                    }))
                    ...
                    var n = e === v.NEXT, i = e === v.PREV, o = this._getItemIndex(t), r = this._items.length - 1,
                        s = i && 0 === o || n && o === r;
                    if (s && !this._config.wrap) return t;
                    var a = e === v.PREV ? -1 : 1, l = (o + a) % this._items.length;
                    return l === -1 ? this._items[this._items.length - 1] : this._items[l]
                }, c.prototype._triggerSlideEvent = function (t, n) {
                    var i = this._getItemIndex(t), o = this._getItemIndex(e(this._element).find(b.ACTIVE_ITEM)[0]),
                        r = e.Event(y.SLIDE, {relatedTarget: t, direction: n, from: o, to: i});
                    return e(this._element).trigger(r), r
                }, c.prototype._setActiveIndicatorElement = function (t) {
                    if (this._indicatorsElement) {
                        e(this._indicatorsElement).find(b.ACTIVE).removeClass(T.ACTIVE);
                        var n = this._indicatorsElement.children[this._getItemIndex(t)];
                        n && e(n).addClass(T.ACTIVE)
                    }
                }, c.prototype._slide = function (t, n) {
                    var i = this, o = e(this._element).find(b.ACTIVE_ITEM)[0], s = this._getItemIndex(o),
                        a = n || o && this._getItemByDirection(t, o), l = this._getItemIndex(a),
                        c = Boolean(this._interval), u = void 0, p = void 0, f = void 0;
                    if (t === v.NEXT ? (u = T.LEFT, p = T.NEXT, f = v.LEFT) : (u = T.RIGHT, p = T.PREV, f = v.RIGHT), a && e(a).hasClass(T.ACTIVE)) return void(this._isSliding = !1);
                    var h = this._triggerSlideEvent(a, f);
                    if (!h.isDefaultPrevented() && o && a) {
                        this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(a);
                        var g = e.Event(y.SLID, {relatedTarget: a, direction: f, from: s, to: l});
                        r.supportsTransitionEnd() && e(this._element).hasClass(T.SLIDE) ? (e(a).addClass(p), r.reflow(a), e(o).addClass(u), e(a).addClass(u), e(o).one(r.TRANSITION_END, function () {
                            e(a).removeClass(u + " " + p).addClass(T.ACTIVE), e(o).removeClass(T.ACTIVE + " " + p + " " + u), i._isSliding = !1, setTimeout(function () {
                                return e(i._element).trigger(g)
                            }, 0)
                        }).emulateTransitionEnd(d)) : (e(o).removeClass(T.ACTIVE), e(a).addClass(T.ACTIVE), this._isSliding = !1, e(this._element).trigger(g)), c && this.cycle()
                    }
                }, c._jQueryInterface = function (t) {
                    return this.each(function () {
                        var n = e(this).data(a), o = e.extend({}, g, e(this).data());
        ...
        return e(document).on(y.CLICK_DATA_API, b.DATA_SLIDE, w._dataApiClickHandler), e(window).on(y.LOAD_DATA_API, function () {
        ...
        var t = "collapse", s = "4.0.0-beta", a = "bs.collapse", l = "." + a, c = ".data-api", u = e.fn[t], d = 600,
            p = {toggle: !0, parent: ""}, f = {toggle: "boolean", parent: "string"}, h = {
                SHOW: "show" + l,
                SHOWN: "shown" + l,
                HIDE: "hide" + l,
                HIDDEN: "hidden" + l,
            ...
            v = {ACTIVES: ".show, .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]'}, y = function () {
                function l(t, i) {
                    n(this, l), this._isTransitioning = !1, this._element = t, this._config = this._getConfig(i), this._triggerArray = e.makeArray(e('[data-toggle="collapse"][href="#' + t.id + '"],' + ('[data-toggle="collapse"][data-target="#' + t.id + '"]')));
                    for (var o = e(v.DATA_TOGGLE), s = 0; s < o.length; s++) {
                        var a = o[s], c = r.getSelectorFromElement(a);
                        null !== c && e(c).filter(t).length > 0 && this._triggerArray.push(a)
                    }
                ...
                return l.prototype.toggle = function () {
                    ...
                    if (!this._isTransitioning && !e(this._element).hasClass(g.SHOW)) {
                        ...
                        if (this._parent && (n = e.makeArray(e(this._parent).children().children(v.ACTIVES)), n.length || (n = null)), !(n && (i = e(n).data(a), i && i._isTransitioning))) {
                            var o = e.Event(h.SHOW);
                            if (e(this._element).trigger(o), !o.isDefaultPrevented()) {
                                n && (l._jQueryInterface.call(e(n), "hide"), i || e(n).data(a, null));
                                var s = this._getDimension();
                                e(this._element).removeClass(g.COLLAPSE).addClass(g.COLLAPSING), this._element.style[s] = 0, this._triggerArray.length && e(this._triggerArray).removeClass(g.COLLAPSED).attr("aria-expanded", !0), this.setTransitioning(!0);
                                var c = function () {
                                    e(t._element).removeClass(g.COLLAPSING).addClass(g.COLLAPSE).addClass(g.SHOW), t._element.style[s] = "", t.setTransitioning(!1), e(t._element).trigger(h.SHOWN)
                                };
                                if (!r.supportsTransitionEnd()) return void c();
                                var u = s[0].toUpperCase() + s.slice(1), p = "scroll" + u;
                                e(this._element).one(r.TRANSITION_END, c).emulateTransitionEnd(d), this._element.style[s] = this._element[p] + "px"
                            }
                        }
                    }
                    ...
                    if (!this._isTransitioning && e(this._element).hasClass(g.SHOW)) {
                        ...
                        if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
                            ...
                            if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", r.reflow(this._element), e(this._element).addClass(g.COLLAPSING).removeClass(g.COLLAPSE).removeClass(g.SHOW), this._triggerArray.length) for (var o = 0; o < this._triggerArray.length; o++) {
                                var s = this._triggerArray[o], a = r.getSelectorFromElement(s);
                                if (null !== a) {
                                    var l = e(a);
                                    l.hasClass(g.SHOW) || e(s).addClass(g.COLLAPSED).attr("aria-expanded", !1)
                                }
                            }
                            this.setTransitioning(!0);
                            var c = function () {
                                t.setTransitioning(!1), e(t._element).removeClass(g.COLLAPSING).addClass(g.COLLAPSE).trigger(h.HIDDEN)
                            };
                            return this._element.style[i] = "", r.supportsTransitionEnd() ? void e(this._element).one(r.TRANSITION_END, c).emulateTransitionEnd(d) : void c()
                        }
                    }
                    ...
                    return n = e.extend({}, p, n), n.toggle = Boolean(n.toggle), r.typeCheckConfig(t, n, f), n
                    ...
                    if (t) {
                        ...
                        n.length && e(n).toggleClass(g.COLLAPSED, !i).attr("aria-expanded", i)
                    }
                    ...
                    return this.each(function () {
                        var n = e(this), o = n.data(a),
                            r = e.extend({}, p, n.data(), "object" === ("undefined" == typeof t ? "undefined" : i(t)) && t);
        ...
        var t = "dropdown", s = "4.0.0-beta", a = "bs.dropdown", l = "." + a, c = ".data-api", u = e.fn[t], d = 27,
            p = 32, f = 9, h = 38, g = 40, m = 3, v = new RegExp(h + "|" + g + "|" + d), y = {
                HIDE: "hide" + l,
                HIDDEN: "hidden" + l,
                SHOW: "show" + l,
                SHOWN: "shown" + l,
            ...
            _ = {placement: w.BOTTOM, offset: 0, flip: !0},
            C = {placement: "string", offset: "(number|string)", flip: "boolean"}, E = function () {
                function c(e, t) {
                    n(this, c), this._element = e, this._popper = null, this._config = this._getConfig(t), this._menu = this._getMenuElement(), this._inNavbar = this._detectNavbar(), this._addEventListeners()
                }

                return c.prototype.toggle = function () {
                    if (!this._element.disabled && !e(this._element).hasClass(T.DISABLED)) {
                        var t = c._getParentFromElement(this._element), n = e(this._menu).hasClass(T.SHOW);
                        if (c._clearMenus(), !n) {
                            var i = {relatedTarget: this._element}, o = e.Event(y.SHOW, i);
                            if (e(t).trigger(o), !o.isDefaultPrevented()) {
                                var r = this._element;
                                e(t).hasClass(T.DROPUP) && (e(this._menu).hasClass(T.MENULEFT) || e(this._menu).hasClass(T.MENURIGHT)) && (r = t), this._popper = new Popper(r, this._menu, this._getPopperConfig()), "ontouchstart" in document.documentElement && !e(t).closest(b.NAVBAR_NAV).length && e("body").children().on("mouseover", null, e.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), e(this._menu).toggleClass(T.SHOW), e(t).toggleClass(T.SHOW).trigger(e.Event(y.SHOWN, i))
                            }
                        }
                    }
                }, c.prototype.dispose = function () {
                    ...
                    return void 0 !== i.placement && (i.placement = w[i.placement.toUpperCase()]), n = e.extend({}, this.constructor.Default, e(this._element).data(), n), r.typeCheckConfig(t, n, this.constructor.DefaultType), n
                    ...
                    return t.hasClass(T.DROPUP) || this._config.placement === w.TOP ? (n = w.TOP, e(this._menu).hasClass(T.MENURIGHT) && (n = w.TOPEND)) : e(this._menu).hasClass(T.MENURIGHT) && (n = w.BOTTOMEND), n
                    ...
                    return this.each(function () {
                        var n = e(this).data(a), o = "object" === ("undefined" == typeof t ? "undefined" : i(t)) ? t : null;
                    ...
                    if (!t || t.which !== m && ("keyup" !== t.type || t.which === f)) for (var n = e.makeArray(e(b.DATA_TOGGLE)), i = 0; i < n.length; i++) {
                        var o = c._getParentFromElement(n[i]), r = e(n[i]).data(a), s = {relatedTarget: n[i]};
                        if (r) {
                            var l = r._menu;
                            if (e(o).hasClass(T.SHOW) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && t.which === f) && e.contains(o, t.target))) {
                                var u = e.Event(y.HIDE, s);
                                e(o).trigger(u), u.isDefaultPrevented() || ("ontouchstart" in document.documentElement && e("body").children().off("mouseover", null, e.noop), n[i].setAttribute("aria-expanded", "false"), e(l).removeClass(T.SHOW), e(o).removeClass(T.SHOW).trigger(e.Event(y.HIDDEN, s)))
                            }
                        }
                    }
                    ...
                    if (!(!v.test(t.which) || /button/i.test(t.target.tagName) && t.which === p || /input|textarea/i.test(t.target.tagName) || (t.preventDefault(), t.stopPropagation(), this.disabled || e(this).hasClass(T.DISABLED)))) {
                        var n = c._getParentFromElement(this), i = e(n).hasClass(T.SHOW);
                        if (!i && (t.which !== d || t.which !== p) || i && (t.which === d || t.which === p)) {
                            if (t.which === d) {
                                var o = e(n).find(b.DATA_TOGGLE)[0];
                                e(o).trigger("focus")
                            }
                            return void e(this).trigger("click")
                        }
                        var r = e(n).find(b.VISIBLE_ITEMS).get();
                        if (r.length) {
                            var s = r.indexOf(t.target);
                            t.which === h && s > 0 && s--, t.which === g && s < r.length - 1 && s++, s < 0 && (s = 0), r[s].focus()
                        }
                    }
                }, o(c, null, [{
                    key: "VERSION", get: function () {
        ...
        return e(document).on(y.KEYDOWN_DATA_API, b.DATA_TOGGLE, E._dataApiKeydownHandler).on(y.KEYDOWN_DATA_API, b.MENU, E._dataApiKeydownHandler).on(y.CLICK_DATA_API + " " + y.KEYUP_DATA_API, E._clearMenus).on(y.CLICK_DATA_API, b.DATA_TOGGLE, function (t) {
            t.preventDefault(), t.stopPropagation(), E._jQueryInterface.call(e(this), "toggle")
        ...
        var t = "modal", s = "4.0.0-beta", a = "bs.modal", l = "." + a, c = ".data-api", u = e.fn[t], d = 300, p = 150,
            f = 27, h = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
            g = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, m = {
                ...
                function c(t, i) {
                    n(this, c), this._config = this._getConfig(i), this._element = t, this._dialog = e(t).find(y.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
                }
                ...
                return c.prototype.toggle = function (e) {
                    ...
                    e.removeData(this._element, a), e(window, document, this._element, this._backdrop).off(l), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null
                }, c.prototype.handleUpdate = function () {
                    this._adjustDialog()
                }, c.prototype._getConfig = function (n) {
                    return n = e.extend({}, h, n), r.typeCheckConfig(t, n, g), n
                }, c.prototype._showElement = function (t) {
                    var n = this, i = r.supportsTransitionEnd() && e(this._element).hasClass(v.FADE);
                    ...
                    var o = e.Event(m.SHOWN, {relatedTarget: t}), s = function () {
                        n._config.focus && n._element.focus(), n._isTransitioning = !1, e(n._element).trigger(o)
                    };
                    i ? e(this._dialog).one(r.TRANSITION_END, s).emulateTransitionEnd(d) : s()
                    ...
                    this._isShown && this._config.keyboard ? e(this._element).on(m.KEYDOWN_DISMISS, function (e) {
                        e.which === f && (e.preventDefault(), t.hide())
                    ...
                    var n = this, i = e(this._element).hasClass(v.FADE) ? v.FADE : "";
                    if (this._isShown && this._config.backdrop) {
                        ...
                        if (!o) return void t();
                        e(this._backdrop).one(r.TRANSITION_END, t).emulateTransitionEnd(p)
                    } else if (!this._isShown && this._backdrop) {
                        e(this._backdrop).removeClass(v.SHOW);
                        var s = function () {
                            n._removeBackdrop(), t && t()
                        };
                        r.supportsTransitionEnd() && e(this._element).hasClass(v.FADE) ? e(this._backdrop).one(r.TRANSITION_END, s).emulateTransitionEnd(p) : s()
                    } else t && t()
                    ...
                    }), e(y.NAVBAR_TOGGLER).each(function (t, n) {
        ...
        return e(document).on(m.CLICK_DATA_API, y.DATA_TOGGLE, function (t) {
            ...
            T._jQueryInterface.call(e(i), s, this)
        }), e.fn[t] = T._jQueryInterface, e.fn[t].Constructor = T, e.fn[t].noConflict = function () {
            return e.fn[t] = u, T._jQueryInterface
        }, T
    }(jQuery), function (e) {
        var t = "scrollspy", s = "4.0.0-beta", a = "bs.scrollspy", l = "." + a, c = ".data-api", u = e.fn[t],
            d = {offset: 10, method: "auto", target: ""},
            p = {offset: "number", method: "string", target: "(string|element)"},
            f = {ACTIVATE: "activate" + l, SCROLL: "scroll" + l, LOAD_DATA_API: "load" + l + c},
            h = {DROPDOWN_ITEM: "dropdown-item", DROPDOWN_MENU: "dropdown-menu", ACTIVE: "active"}, g = {
            ...
            }, m = {OFFSET: "offset", POSITION: "position"}, v = function () {
                function c(t, i) {
                    var o = this;
                    n(this, c), this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(i), this._selector = this._config.target + " " + g.NAV_LINKS + "," + (this._config.target + " " + g.LIST_ITEMS + ",") + (this._config.target + " " + g.DROPDOWN_ITEMS), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, e(this._scrollElement).on(f.SCROLL, function (e) {
                        return o._process(e)
                    }), this.refresh(), this._process()
                }

                return c.prototype.refresh = function () {
                    var t = this, n = this._scrollElement !== this._scrollElement.window ? m.POSITION : m.OFFSET,
                    ...
                    return r.typeCheckConfig(t, n, p), n
                    ...
                    var i = e(n.join(","));
                    i.hasClass(h.DROPDOWN_ITEM) ? (i.closest(g.DROPDOWN).find(g.DROPDOWN_TOGGLE).addClass(h.ACTIVE), i.addClass(h.ACTIVE)) : (i.addClass(h.ACTIVE), i.parents(g.NAV_LIST_GROUP).prev(g.NAV_LINKS + ", " + g.LIST_ITEMS).addClass(h.ACTIVE)), e(this._scrollElement).trigger(f.ACTIVATE, {relatedTarget: t})
                }, c.prototype._clear = function () {
                    e(this._selector).filter(g.ACTIVE).removeClass(h.ACTIVE)
                }, c._jQueryInterface = function (t) {
                    return this.each(function () {
                        var n = e(this).data(a), o = "object" === ("undefined" == typeof t ? "undefined" : i(t)) && t;
                        if (n || (n = new c(this, o), e(this).data(a, n)), "string" == typeof t) {
                            if (void 0 === n[t]) throw new Error('No method named "' + t + '"');
                            n[t]()
                        }
        ...
        return e(window).on(f.LOAD_DATA_API, function () {
        ...
        var t = "tab", i = "4.0.0-beta", s = "bs.tab", a = "." + s, l = ".data-api", c = e.fn[t], u = 150, d = {
                HIDE: "hide" + a,
                HIDDEN: "hidden" + a,
                SHOW: "show" + a,
                SHOWN: "shown" + a,
            ...
            f = {
                ...
                return t.prototype.show = function () {
                    var t = this;
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(p.ACTIVE) || e(this._element).hasClass(p.DISABLED))) {
                        var n = void 0, i = void 0, o = e(this._element).closest(f.NAV_LIST_GROUP)[0],
                            s = r.getSelectorFromElement(this._element);
                        o && (i = e.makeArray(e(o).find(f.ACTIVE)), i = i[i.length - 1]);
                        var a = e.Event(d.HIDE, {relatedTarget: this._element}), l = e.Event(d.SHOW, {relatedTarget: i});
                        if (i && e(i).trigger(a), e(this._element).trigger(l), !l.isDefaultPrevented() && !a.isDefaultPrevented()) {
                            s && (n = e(s)[0]), this._activate(this._element, o);
                            var c = function () {
                                var n = e.Event(d.HIDDEN, {relatedTarget: t._element}),
                                    o = e.Event(d.SHOWN, {relatedTarget: i});
                    ...
                    var o = this, s = e(n).find(f.ACTIVE)[0],
                        a = i && r.supportsTransitionEnd() && s && e(s).hasClass(p.FADE), l = function () {
                            return o._transitionComplete(t, s, a, i)
                        };
                    s && a ? e(s).one(r.TRANSITION_END, l).emulateTransitionEnd(u) : l(), s && e(s).removeClass(p.SHOW)
                    ...
                    if (n) {
                        ...
                        s && e(s).removeClass(p.ACTIVE), n.setAttribute("aria-expanded", !1)
                    }
                    if (e(t).addClass(p.ACTIVE), t.setAttribute("aria-expanded", !0), i ? (r.reflow(t), e(t).addClass(p.SHOW)) : e(t).removeClass(p.FADE), t.parentNode && e(t.parentNode).hasClass(p.DROPDOWN_MENU)) {
                        var a = e(t).closest(f.DROPDOWN)[0];
                        a && e(a).find(f.DROPDOWN_TOGGLE).addClass(p.ACTIVE), t.setAttribute("aria-expanded", !0)
                    }
                    o && o()
                }, t._jQueryInterface = function (n) {
                    return this.each(function () {
        ...
        var t = "tooltip", s = "4.0.0-beta", a = "bs.tooltip", l = "." + a, c = e.fn[t], u = 150, d = "bs-tooltip",
            p = new RegExp("(^|\\s)" + d + "\\S+", "g"), f = {
                animation: "boolean",
                template: "string",
            ...
            }, h = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, g = {
                animation: !0,
            ...
            b = {HOVER: "hover", FOCUS: "focus", CLICK: "click", MANUAL: "manual"}, w = function () {
                function c(e, t) {
                    n(this, c), this._isEnabled = !0, this._timeout = 0, this._hoverState = "", this._activeTrigger = {}, this._popper = null, this.element = e, this.config = this._getConfig(t), this.tip = null, this._setListeners()
                }
                ...
                return c.prototype.enable = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        o.setAttribute("id", s), this.element.setAttribute("aria-describedby", s), this.setContent(), this.config.animation && e(o).addClass(y.FADE);
                        var a = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
                            l = this._getAttachment(a);
                        this.addAttachmentClass(l);
                        var u = this.config.container === !1 ? document.body : e(this.config.container);
                        ...
                        }), e(o).addClass(y.SHOW), "ontouchstart" in document.documentElement && e("body").children().on("mouseover", null, e.noop);
                        var d = function () {
                            t.config.animation && t._fixTransition();
                            var n = t._hoverState;
                            t._hoverState = null, e(t.element).trigger(t.constructor.Event.SHOWN), n === m.OUT && t._leave(null, t)
                        };
                        r.supportsTransitionEnd() && e(this.tip).hasClass(y.FADE) ? e(this.tip).one(r.TRANSITION_END, d).emulateTransitionEnd(c._TRANSITION_DURATION) : d()
                    }
                }, c.prototype.hide = function (t) {
                    ...
                    e(this.element).trigger(o), o.isDefaultPrevented() || (e(i).removeClass(y.SHOW), "ontouchstart" in document.documentElement && e("body").children().off("mouseover", null, e.noop), this._activeTrigger[b.CLICK] = !1, this._activeTrigger[b.FOCUS] = !1, this._activeTrigger[b.HOVER] = !1, r.supportsTransitionEnd() && e(this.tip).hasClass(y.FADE) ? e(i).one(r.TRANSITION_END, s).emulateTransitionEnd(u) : s(), this._hoverState = "")
                }, c.prototype.update = function () {
                    ...
                    this.setElementContent(t.find(T.TOOLTIP_INNER), this.getTitle()), t.removeClass(y.FADE + " " + y.SHOW)
                    ...
                    n.forEach(function (n) {
                        if ("click" === n) e(t.element).on(t.constructor.Event.CLICK, t.config.selector, function (e) {
                            ...
                            var i = n === b.HOVER ? t.constructor.Event.MOUSEENTER : t.constructor.Event.FOCUSIN,
                                o = n === b.HOVER ? t.constructor.Event.MOUSELEAVE : t.constructor.Event.FOCUSOUT;
                    ...
                    var t = e(this.getTipElement()), n = t.attr("class").match(p);
    ...
    (function (r) {
        var a = "popover", l = "4.0.0-beta", c = "bs.popover", u = "." + c, d = r.fn[a], p = "bs-popover",
            f = new RegExp("(^|\\s)" + p + "\\S+", "g"), h = r.extend({}, s.Default, {
                placement: "right",
                trigger: "click",
                content: "",
                template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
            }), g = r.extend({}, s.DefaultType, {content: "(string|element|function)"}), m = {FADE: "fade", SHOW: "show"},
            v = {TITLE: ".popover-header", CONTENT: ".popover-body"}, y = {
                HIDE: "hide" + u,
                HIDDEN: "hidden" + u,
                SHOW: "show" + u,
                SHOWN: "shown" + u,
                ...
                function d() {
                    return n(this, d), e(this, s.apply(this, arguments))
                }

                return t(d, s), d.prototype.isWithContent = function () {
                    return this.getTitle() || this._getContent()
                }, d.prototype.addAttachmentClass = function (e) {
                    r(this.getTipElement()).addClass(p + "-" + e)
                }, d.prototype.getTipElement = function () {
                    return this.tip = this.tip || r(this.config.template)[0]
                }, d.prototype.setContent = function () {
                    var e = r(this.getTipElement());
                    this.setElementContent(e.find(v.TITLE), this.getTitle()), this.setElementContent(e.find(v.CONTENT), this._getContent()), e.removeClass(m.FADE + " " + m.SHOW)
                }, d.prototype._getContent = function () {
                    return this.element.getAttribute("data-content") || ("function" == typeof this.config.content ? this.config.content.call(this.element) : this.config.content)
                }, d.prototype._cleanTipClass = function () {
                    var e = r(this.getTipElement()), t = e.attr("class").match(f);
                    null !== t && t.length > 0 && e.removeClass(t.join(""))
                }, d._jQueryInterface = function (e) {
                    return this.each(function () {
                        var t = r(this).data(c), n = "object" === ("undefined" == typeof e ? "undefined" : i(e)) ? e : null;
                        if ((t || !/destroy|hide/.test(e)) && (t || (t = new d(this, n), r(this).data(c, t)), "string" == typeof e)) {
        ...
        return r.fn[a] = T._jQueryInterface, r.fn[a].Constructor = T, r.fn[a].noConflict = function () {
            return r.fn[a] = d, T._jQueryInterface
        }, T
    })(jQuery)
}(), function (e) {
    "use strict";
    e.fn.bPopup = function (t, n) {
        function i() {
            g(b.onOpen), F = (H.data("bPopup") || 0) + 1, w = R + F + "__", C = "auto" !== b.position[1], E = "auto" !== b.position[0], S = "fixed" === b.positionStyle, A = N.outerHeight(!0), O = N.outerWidth(!0), b.loadUrl ? o() : r()
        }

        function o() {
            switch (b.contentContainer = e(b.contentContainer || N), b.content) {
                case"iframe":
                    var t = e('<iframe class="b-iframe" ' + b.iframeAttr + "></iframe>");
                    t.appendTo(b.contentContainer), A = N.outerHeight(!0), O = N.outerWidth(!0), r(), t.attr("src", b.loadUrl), g(b.loadCallback);
                    break;
                case"image":
                    r(), e("<img />").load(function () {
                        g(b.loadCallback), l(e(this))
                    }).attr("src", b.loadUrl).hide().appendTo(b.contentContainer);
                    break;
                default:
                    r(), e('<div class="b-ajax-wrapper"></div>').load(b.loadUrl, b.loadData, function (t, n, i) {
                        g(b.loadCallback, n), l(e(this))
                    }).hide().appendTo(b.contentContainer)
            }
        }

        function r() {
            b.modal && e('<div class="b-modal ' + w + '"></div>').css({
                backgroundColor: b.modalColor,
                position: "fixed",
                top: 0,
                right: 0,
                bottom: 0,
                ...
                opacity: 0,
                zIndex: b.zIndex + F
            }).appendTo(b.appendTo).fadeTo(b.speed, b.opacity), m(), N.data("bPopup", b).data("id", w).css({
                left: "slideIn" == b.transition || "slideBack" == b.transition ? "slideBack" == b.transition ? L.scrollLeft() + j : (k + O) * -1 : f(!(!b.follow[0] && E || S)),
                position: b.positionStyle || "absolute",
                top: "slideDown" == b.transition || "slideUp" == b.transition ? "slideUp" == b.transition ? L.scrollTop() + $ : x + A * -1 : h(!(!b.follow[1] && C || S)),
                "z-index": b.zIndex + F + 1
            }).each(function () {
                b.appending && e(this).appendTo(b.appendTo)
            }), d(!0)
        }

        function s() {
            return b.modal && e(".b-modal." + N.data("id")).fadeTo(b.speed, 0, function () {
                e(this).remove()
            }), u(), clearTimeout(I), d(), !1
        }

        function a(t) {
            $ = y(), j = T(), _ = v(), (_.x || _.y) && (clearTimeout(D), D = setTimeout(function () {
                m(), t = t || b.followSpeed;
                var n = {};
                _.x && (n.left = b.follow[0] ? f(!0) : "auto"), _.y && (n.top = b.follow[1] ? h(!0) : "auto"), N.dequeue().each(function () {
                    S ? e(this).css({left: k, top: x}) : e(this).animate(n, t, b.followEasing)
                })
            }, 50))
        }
        ...
        function l(e) {
            ...
            b.contentContainer.css({
                height: n,
                width: t
            }), n >= N.height() && (i.height = N.height()), t >= N.width() && (i.width = N.width()), A = N.outerHeight(!0), O = N.outerWidth(!0), m(), b.contentContainer.css({
                height: "auto",
                width: "auto"
            }), i.left = f(!(!b.follow[0] && E || S)), i.top = h(!(!b.follow[1] && C || S)), N.animate(i, 250, function () {
                e.show(), _ = v()
            })
        }

        function c() {
            H.data("bPopup", F), N.delegate(".bClose, ." + b.closeClass, "click." + w, s), b.modalClose && e(".b-modal." + w).css("cursor", "pointer").bind("click", s), W || !b.follow[0] && !b.follow[1] || H.bind("scroll." + w, function () {
                if (_.x || _.y) {
                    var e = {};
                    _.x && (e.left = b.follow[0] ? f(!S) : "auto"), _.y && (e.top = b.follow[1] ? h(!S) : "auto"), N.dequeue().animate(e, b.followSpeed, b.followEasing)
                }
            }).bind("resize." + w, function () {
                a()
            }), b.escClose && L.bind("keydown." + w, function (e) {
                27 == e.which && s()
            })
        }

        function u() {
            b.scrollBar || e("html").css("overflow", "auto"), e(".b-modal." + w).unbind("click"), L.unbind("keydown." + w), H.unbind("." + w).data("bPopup", H.data("bPopup") - 1 > 0 ? H.data("bPopup") - 1 : null), N.undelegate(".bClose, ." + b.closeClass, "click." + w, s).data("bPopup", null)
        }

        function d(e) {
            function t(t) {
                N.css({display: "block", opacity: 1}).animate(t, b.speed, b.easing, function () {
                    p(e)
                })
            }

            switch (e ? b.transition : b.transitionClose || b.transition) {
                case"slideIn":
                    t({left: e ? f(!(!b.follow[0] && E || S)) : L.scrollLeft() - (O || N.outerWidth(!0)) - M});
                    break;
                case"slideBack":
                    t({left: e ? f(!(!b.follow[0] && E || S)) : L.scrollLeft() + j + M});
                    break;
                case"slideDown":
                    t({top: e ? h(!(!b.follow[1] && C || S)) : L.scrollTop() - (A || N.outerHeight(!0)) - M});
                    break;
                case"slideUp":
                    t({top: e ? h(!(!b.follow[1] && C || S)) : L.scrollTop() + $ + M});
                    break;
                default:
                    N.stop().fadeTo(b.speed, e ? 1 : 0, function () {
                        p(e)
                    })
            }
        }
        ...
        function p(e) {
            e ? (c(), g(n), b.autoClose && (I = setTimeout(s, b.autoClose))) : (N.hide(), g(b.onClose), b.loadUrl && (b.contentContainer.empty(), N.css({
                height: "auto",
                width: "auto"
            })))
        }
        ...
        function f(e) {
            return e ? k + L.scrollLeft() : k
        }

        function h(e) {
            return e ? x + L.scrollTop() : x
        }

        function g(t, n) {
            e.isFunction(t) && t.call(N, n)
        }

        function m() {
            x = C ? b.position[1] : Math.max(0, ($ - N.outerHeight(!0)) / 2 - b.amsl), k = E ? b.position[0] : (j - N.outerWidth(!0)) / 2, _ = v()
        }

        function v() {
            return {x: j > N.outerWidth(!0), y: $ > N.outerHeight(!0)}
        }
        ...
        var b = e.extend({}, e.fn.bPopup.defaults, t);
        b.scrollBar || e("html").css("overflow", "hidden");
        var w, _, C, E, S, x, k, A, O, D, I, N = this, L = e(document), P = window, H = e(P), $ = y(), j = T(),
            R = "__b-popup", W = /OS 6(_\d)+/i.test(navigator.userAgent), M = 200, F = 0;
