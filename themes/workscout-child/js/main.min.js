!function (e, t) {
    ...
    function g(e) {
        ...
        return o ? o : (t = n.body.appendChild(n.createElement(i)), o = ve.css(t, "display"), t.parentNode.removeChild(t), "none" === o && (o = "block"), Ue[i] = o, o)
    }

    function y(e, t) {
        for (var n, i, o = [], r = 0, s = e.length; r < s; r++)i = e[r], i.style && (n = i.style.display, t ? ("none" === n && (o[r] = qe.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && _e(i) && (o[r] = g(i))) : "none" !== n && (o[r] = "none", qe.set(i, "display", n)));
    ...
    function F(e, t, n) {
        var i, o = lt(e), r = L(e, t, o), s = "border-box" === ve.css(e, "boxSizing", !1, o);
    ...
    function B(e, t, n) {
        var i, o, r, s, a, l, c, d, u = "width"in t || "height"in t, p = this, f = {}, h = e.style, v = e.nodeType && _e(e), g = qe.get(e, "fxshow");
    ...
    function X(e, t, n) {
        var i, o, r = 0, s = X.prefilters.length, a = ve.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (o)return!1;
        ...
        }, c = a.promise({elem: e, props: ve.extend({}, t), opts: ve.extend(!0, {specialEasing: {}, easing: ve.easing._default}, n), originalProperties: t, originalOptions: n, startTime: vt || W(), duration: n.duration, tweens: [], createTween: function (t, n) {
        ...
        for (U(d, c.opts.specialEasing); r < s; r++)if (i = X.prefilters[r].call(c, e, d, c.opts))return ve.isFunction(i.stop) && (ve._queueHooks(c.elem, c.opts.queue).stop = ve.proxy(i.stop, i)), i;
        return ve.map(d, _, c), ve.isFunction(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), ve.fx.timer(ve.extend(l, {elem: e, anim: c, queue: c.opts.queue})), c
    }
    ...
    ve.fn = ve.prototype = {jquery: he, constructor: ve, length: 0, toArray: function () {
        return oe.call(this)
    }, get: function (e) {
        ...
        return s
    }, ve.extend({expando: "jQuery" + (he + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
        throw new Error(e)
    }, noop: function () {
    ...
    var be = function (e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : W) !== N && L(t), t = t || N, P)) {
        ...
        function b(e, n) {
            var o = n.length > 0, r = e.length > 0, s = function (i, s, a, l, c) {
                ...
                for (c && (j = s === N || s || c); h !== x && null != (d = w[h]); h++) {
                    if (r && d) {
                        for (u = 0, s || d.ownerDocument === N || (L(d), a = !P); p = e[u++];)if (p(d, s || N, a)) {
                            l.push(d);
                            break
                        }
                        c && (R = b)
        ...
        T = t.support = {}, C = t.isXML = function (e) {
            ...
            return i !== N && 9 === i.nodeType && i.documentElement ? (N = i, O = N.documentElement, P = !C(N), W !== N && (n = N.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), T.attributes = o(function (e) {
                ...
                return O.appendChild(e).id = z, !N.getElementsByName || !N.getElementsByName(z).length
            ...
            }, M = [], q = [], (T.qsa = ge.test(N.querySelectorAll)) && (o(function (e) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !T.sortDetached && t.compareDocumentPosition(e) === n ? e === N || e.ownerDocument === W && I(W, e) ? -1 : t === N || t.ownerDocument === W && I(W, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t)return H = !0, 0;
            ...
            if ((e.ownerDocument || e) !== N && L(e), n = n.replace(de, "='$1']"), T.matchesSelector && P && !X[n + " "] && (!M || !M.test(n)) && (!q || !q.test(n)))try {
                var i = F.call(e, n);
            ...
            return(e.ownerDocument || e) !== N && L(e), I(e, t)
        }, t.attr = function (e, t) {
            ...
            return n
        }, k = t.selectors = {cacheLength: 50, createPseudo: i, match: fe, attrHandle: {}, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function (e) {
        ...
        return p.prototype = k.filters = k.pseudos, k.setFilters = new p, $ = t.tokenize = function (e, n) {
            ...
            for (a = e, l = [], c = k.preFilter; a;) {
                ...
                for (s in k.filter)!(o = fe[s].exec(a)) || c[s] && !(o = c[s](o)) || (i = o.shift(), r.push({value: i, type: s, matches: o}), a = a.slice(i.length));
                if (!i)break
            }
        ...
        }, T.sortStable = z.split("").sort(Y).join("") === z, T.detectDuplicates = !!H, L(), T.sortDetached = o(function (e) {
    ...
    }, ve.extend({isReady: !1, readyWait: 1, ready: function (e) {
        (e === !0 ? --ve.readyWait : ve.isReady) || (ve.isReady = !0, e !== !0 && --ve.readyWait > 0 || Ne.resolveWith(ne, [ve]))
    }}), ve.ready.then = Ne.then, "complete" === ne.readyState || "loading" !== ne.readyState && !ne.documentElement.doScroll ? e.setTimeout(ve.ready) : (ne.addEventListener("DOMContentLoaded", u), e.addEventListener("load", u));
    ...
    p.uid = 1, p.prototype = {cache: function (e) {
    ...
    ve.extend({hasData: function (e) {
        ...
        qe.remove(e, t)
    }}), ve.fn.extend({data: function (e, t) {
    ...
    }}), ve.extend({queue: function (e, t, n) {
        var i;
        ...
        var n = t + "queueHooks";
        return qe.get(e, n) || qe.access(e, n, {empty: ve.Callbacks("once memory").add(function () {
            qe.remove(e, [t + "queue", n])
        })})
    }}), ve.fn.extend({queue: function (e, t) {
        var n = 2;
    ...
    var ze = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, We = new RegExp("^(?:([+-])=|)(" + ze + ")([a-z%]*)$", "i"), Re = ["Top", "Right", "Bottom", "Left"], _e = function (e, t) {
    ...
    ve.fn.extend({show: function () {
        ...
        return"boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function () {
            _e(this) ? ve(this).show() : ve(this).hide()
        })
    }});
    ...
    ve.event = {global: {}, add: function (e, t, n, i, o) {
        ...
        }), t = (t || "").match(He) || [""], c = t.length; c--;)a = et.exec(t[c]) || [], f = v = a[1], h = (a[2] || "").split(".").sort(), f && (u = ve.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = ve.event.special[f] || {}, d = ve.extend({type: f, origType: v, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && ve.expr.match.needsContext.test(o), namespace: h.join(".")}, r), (p = l[f]) || (p = l[f] = [], p.delegateCount = 0, u.setup && u.setup.call(e, i, h, s) !== !1 || e.addEventListener && e.addEventListener(f, s)), u.add && (u.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, d) : p.push(d), ve.event.global[f] = !0)
    ...
    }, ve.Event.prototype = {constructor: ve.Event, isDefaultPrevented: T, isPropagationStopped: T, isImmediatePropagationStopped: T, isSimulated: !1, preventDefault: function () {
    ...
    }}, ve.each({altKey: !0, bubbles: !0, cancelable: !0, changedTouches: !0, ctrlKey: !0, detail: !0, eventPhase: !0, metaKey: !0, pageX: !0, pageY: !0, shiftKey: !0, view: !0, "char": !0, charCode: !0, key: !0, keyCode: !0, button: !0, buttons: !0, clientX: !0, clientY: !0, offsetX: !0, offsetY: !0, pointerId: !0, pointerType: !0, screenX: !0, screenY: !0, targetTouches: !0, toElement: !0, touches: !0, which: function (e) {
        var t = e.button;
    ...
    }}), ve.fn.extend({detach: function (e) {
        return H(this, e, !0)
    }, remove: function (e) {
        return H(this, e)
    }, text: function (e) {
    ...
    !function () {
        ...
        a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", fe.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), ve.extend(fe, {pixelPosition: function () {
            return t(), n
    ...
    var ct = /^(none|table(?!-c[ea]).+)/, dt = /^--/, ut = {position: "absolute", visibility: "hidden", display: "block"}, pt = {letterSpacing: "0", fontWeight: "400"}, ft = ["Webkit", "Moz", "ms"], ht = ne.createElement("div").style;
    ve.extend({cssHooks: {opacity: {get: function (e, t) {
        ...
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            ...
            return l || (t = P(a)), s = ve.cssHooks[t] || ve.cssHooks[a], void 0 === n ? s && "get"in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t] : (r = typeof n, "string" === r && (o = We.exec(n)) && o[1] && (n = v(e, t, o), r = "number"), void(null != n && n === n && ("number" === r && (n += o && o[3] || (ve.cssNumber[a] ? "" : "px")), fe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set"in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))))
        }
    }, css: function (e, t, n, i) {
        var o, r, s, a = ve.camelCase(t), l = dt.test(t);
        return l || (t = P(a)), s = ve.cssHooks[t] || ve.cssHooks[a], s && "get"in s && (o = s.get(e, !0, n)), void 0 === o && (o = L(e, t, i)), "normal" === o && t in pt && (o = pt[t]), "" === n || n ? (r = parseFloat(o), n === !0 || isFinite(r) ? r || 0 : o) : o
    }}), ve.each(["height", "width"], function (e, t) {
        ve.cssHooks[t] = {get: function (e, n, i) {
            if (n)return!ct.test(ve.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? F(e, t, i) : Be(e, ut, function () {
                return F(e, t, i)
            })
        }, set: function (e, n, i) {
    ...
    }), ve.cssHooks.marginLeft = N(fe.reliableMarginLeft, function (e, t) {
        ...
        ve.cssHooks[e + t] = {expand: function (n) {
            for (var i = 0, o = {}, r = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++)o[e + Re[i] + t] = r[i] || r[i - 2] || r[0];
            return o
        }}, st.test(e) || (ve.cssHooks[e + t].set = q)
    }), ve.fn.extend({css: function (e, t) {
    ...
    }}), ve.Tween = I, I.prototype = {constructor: I, init: function (e, t, n, i, o, r) {
    ...
    }}, ve.easing = {linear: function (e) {
        return e
    }, swing: function (e) {
        return.5 - Math.cos(e * Math.PI) / 2
    }, _default: "swing"}, ve.fx = I.prototype.init, ve.fx.step = {};
    var vt, gt, yt = /^(?:toggle|show|hide)$/, mt = /queueHooks$/;
    ve.Animation = ve.extend(X, {tweeners: {"*": [function (e, t) {
    ...
    }, ve.fn.extend({fadeTo: function (e, t, n, i) {
    ...
    }}}, propFix: {"for": "htmlFor", "class": "className"}}), fe.optSelected || (ve.propHooks.selected = {get: function (e) {
        var t = e.parentNode;
    ...
    }), ve.fn.extend({addClass: function (e) {
    ...
    ve.fn.extend({val: function (e) {
        ...
        })) : o ? (t = ve.valHooks[o.type] || ve.valHooks[o.nodeName.toLowerCase()], t && "get"in t && void 0 !== (n = t.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(kt, "") : null == n ? "" : n)) : void 0
    }}), ve.extend({valHooks: {option: {get: function (e) {
        ...
        ve.valHooks[this] = {set: function (e, t) {
    ...
    ve.extend(ve.event, {trigger: function (t, n, i, o) {
    ...
    }}), ve.fn.extend({trigger: function (e, t) {
        return this.each(function () {
    ...
    }), ve.fn.extend({hover: function (e, t) {
    ...
    ve.param = function (e, t) {
        ...
        return i.join("&")
    }, ve.fn.extend({serialize: function () {
        ...
        return this.map(function () {
            ...
            return e ? ve.makeArray(e) : this
                ...
                var e = this.type;
                return this.name && !ve(this).is(":disabled") && Ht.test(this.nodeName) && !Dt.test(e) && (this.checked || !Xe.test(e))
            }).map(function (e, t) {
                var n = ve(this).val();
    ...
    Rt.href = Ct.href, ve.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: Ct.href, type: "GET", isLocal: qt.test(Ct.protocol), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": Wt, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /\bxml\b/, html: /\bhtml/, json: /\bjson\b/}, responseFields: {xml: "responseXML", text: "responseText", json: "responseJSON"}, converters: {"* text": String, "text html": !0, "text json": JSON.parse, "text xml": ve.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function (e, t) {
        ...
        var o, r, s, a, l, c, d, u, p, f, h = ve.ajaxSetup({}, n), v = h.context || h, g = h.context && (v.nodeType || v.jquery) ? ve(v) : ve.event, y = ve.Deferred(), m = ve.Callbacks("once memory"), w = h.statusCode || {}, b = {}, x = {}, T = "canceled", k = {readyState: 0, getResponseHeader: function (e) {
            var t;
            if (d) {
    ...
    }, ve.fn.extend({wrapAll: function (e) {
        var t;
    ...
    var _t = {0: 200, 1223: 204}, Bt = ve.ajaxSettings.xhr();
    fe.cors = !!Bt && "withCredentials"in Bt, fe.ajax = Bt = !!Bt, ve.ajaxTransport(function (t) {
        var n, i;
        if (fe.cors || Bt && !t.crossDomain)return{send: function (o, r) {
            var s, a = t.xhr();
            ...
            n = function (e) {
                return function () {
                    n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(_t[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                }
    ...
    }), ve.ajaxSetup({accepts: {script: "text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"}, contents: {script: /\b(?:java|ecma)script\b/}, converters: {"text script": function (e) {
    ...
    ve.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
        ...
        var o, r, s, a = t.jsonp !== !1 && (Xt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Xt.test(t.data) && "data");
        ...
        return a > -1 && (i = Y(e.slice(a)), e = e.slice(0, a)), ve.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), s.length > 0 && ve.ajax({url: e, type: o || "GET", dataType: "html", data: t}).done(function (e) {
    ...
    }, ve.offset = {setOffset: function (e, t, n) {
    ...
    }}, ve.fn.extend({offset: function (e) {
        if (arguments.length)return void 0 === e ? this : this.each(function (t) {
            ve.offset.setOffset(this, e, t)
        });
        var t, n, i, o, r = this[0];
        return r ? r.getClientRects().length ? (i = r.getBoundingClientRect(), t = r.ownerDocument, n = t.documentElement, o = t.defaultView, {top: i.top + o.pageYOffset - n.clientTop, left: i.left + o.pageXOffset - n.clientLeft}) : {top: 0, left: 0} : void 0
    }, position: function () {
        if (this[0]) {
            var e, t, n = this[0], i = {top: 0, left: 0};
            return"fixed" === ve.css(n, "position") ? t = n.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), o(e[0], "html") || (i = e.offset()), i = {top: i.top + ve.css(e[0], "borderTopWidth", !0), left: i.left + ve.css(e[0], "borderLeftWidth", !0)}), {top: t.top - i.top - ve.css(n, "marginTop", !0), left: t.left - i.left - ve.css(n, "marginLeft", !0)}
        }
        ...
        ve.cssHooks[t] = N(fe.pixelPosition, function (e, n) {
            if (n)return n = L(e, t), at.test(n) ? ve(e).position()[t] + "px" : n
        })
    ...
    }), ve.fn.extend({bind: function (e, t, n) {
    ...
    $(".carousel").slick({dots: !0, arrows: !1, infinite: !0, speed: 500, slidesToShow: 1, slidesToScroll: 1, autoplay: !0, autoplaySpeed: 7500})
}), $(".form__input").focusout(function () {
    var e = $(this).val();
    "" === e ? $(this).removeClass("has-value") : $(this).addClass("has-value")
}), $(".form__side__bottom").click(function () {
    $(".register").is(":visible") || ($(".login").hide(), $(".register").show(), $(".form__side__bottom .form__side__image_active").addClass("opacity1"), $(".form__side__top .form__side__image_active").removeClass("opacity1"))
}), $('.toggle__link').click(function (e) {
    e.preventDefault(), $(".register").is(":visible") || ($(".login").hide(), $(".register").show(), $(".form__side__bottom .form__side__image_active").addClass("opacity1"), $(".form__side__top .form__side__image_active").removeClass("opacity1"))
}), $(".form__side__top").click(function () {
    $(".login").is(":visible") || ($(".register").hide(), $(".login").show(), $(".form__side__top .form__side__image_active").addClass("opacity1"), $(".form__side__bottom .form__side__image_active").removeClass("opacity1"))
}), function () {
    for (var e = document.querySelectorAll(".youtube"), t = 0; t < e.length; t++) {
        var n = "https://img.youtube.com/vi/" + e[t].dataset.embed + "/hqdefault.jpg", i = new Image;
        i.src = n, i.addEventListener("load", function () {
            e[t].appendChild(i)
        }(t)), e[t].addEventListener("click", function () {
            var e = document.createElement("iframe");
            e.setAttribute("frameborder", "0"), e.setAttribute("allowfullscreen", ""), e.setAttribute("src", "https://www.youtube.com/embed/" + this.dataset.embed + "?rel=0&showinfo=0&autoplay=1"), e.setAttribute("width", "640px"), e.setAttribute("height", "450px"), this.innerHTML = "", this.appendChild(e)
        })
    }
}();