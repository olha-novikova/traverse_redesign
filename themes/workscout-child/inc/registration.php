...
function wc_custom_user_redirect( $redirect, $user ) {
    ...
    if( $role == 'employer' ) {
        ...
        if(get_option( 'job_manager_job_dashboard_page_id')) { 
          ...
          //  $redirect_to=  home_url("/brandhome/");
		 //   $redirect=  home_url("/brandhome/");
		 $redirect= get_site_url()."/brandhome/";
        };
     ...
     /*   if(get_option( 'resume_manager_candidate_dashboard_page_id')) { 
          ...
          //  $redirect_to= home_url("/influencer");
		//	$redirect=  home_url("/influencer");
		 $redirect= get_site_url()."/influencer/";
        };*/
				 $redirect= get_site_url()."/influencer/";
