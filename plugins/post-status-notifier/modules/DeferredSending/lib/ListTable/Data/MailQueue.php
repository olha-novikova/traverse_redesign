 ...
 * @version   $Id: MailQueue.php 332 2014-11-05 18:26:41Z timoreithde $
 * @package
 */
class Psn_Module_DeferredSending_ListTable_Data_MailQueue implements IfwPsn_Wp_Plugin_ListTable_Data_Interface
{
    /**
     * @var string
     */
    protected $_model = 'Psn_Module_DeferredSending_Model_MailQueue';
