 ...
 * @version   $Id: LimitCountField.php 353 2014-12-14 16:55:04Z timoreithde $
 * @package   
 */ 
class Psn_Module_Limitations_Test_LimitCountField implements IfwPsn_Wp_Plugin_Selftest_Interface
{
    ...
    {
        return __('Limitation count field on rules table', 'psn_lmt');
    }
    ...
    {
        if ($this->_dbPatcher->isFieldLimitCount()) {
            $this->_result = true;
        }
    }
    ...
    {
        $this->_dbPatcher->createRulesFieldLimitCount();
