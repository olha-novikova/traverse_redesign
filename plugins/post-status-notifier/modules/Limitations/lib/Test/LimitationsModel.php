 ...
 * @version   $Id: LimitationsModel.php 352 2014-12-13 19:34:18Z timoreithde $
 * @package   
 */ 
class Psn_Module_Limitations_Test_LimitationsModel implements IfwPsn_Wp_Plugin_Selftest_Interface
{
    ...
    {
        return __('Limitations table', 'psn_lmt');
    }
    ...
    {
        $model = new Psn_Module_Limitations_Model_Limitations();
        if ($model->exists()) {
            $this->_result = true;
        }
    }
    ...
    {
        $activation = new Psn_Module_Limitations_Installer_Activation();
