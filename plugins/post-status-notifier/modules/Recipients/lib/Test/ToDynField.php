 ...
 * @version   $Id: ToDynField.php 365 2015-04-02 22:10:47Z timoreithde $
 * @package   
 */ 
class Psn_Module_Recipients_Test_ToDynField implements IfwPsn_Wp_Plugin_Selftest_Interface
{
    ...
    {
        return __('Dynamic recipient field', 'psn_rec');
    }
