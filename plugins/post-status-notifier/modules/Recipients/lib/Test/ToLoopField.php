 ...
 * @version   $Id: ToLoopField.php 238 2014-05-10 15:42:56Z timoreithde $
 * @package   
 */ 
class Psn_Module_Recipients_Test_ToLoopField implements IfwPsn_Wp_Plugin_Selftest_Interface
{
    ...
    {
        return __('One email by To recipient field', 'psn_rec');
    }
