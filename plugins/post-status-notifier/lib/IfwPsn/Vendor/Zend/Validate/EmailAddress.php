 ...
 * @version    $Id: EmailAddress.php 269 2014-04-25 23:29:54Z timoreithde $
 */
...
class IfwPsn_Vendor_Zend_Validate_EmailAddress extends IfwPsn_Vendor_Zend_Validate_Abstract
{
     ...
     *
     * @param array|IfwPsn_Vendor_Zend_Config $options OPTIONAL
     * @return void
     */
     ...
     *
     * @param array $options
     * @return IfwPsn_Vendor_Zend_Validate_EmailAddress fluid interface
     */
