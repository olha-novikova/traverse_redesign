 ...
 * @copyright  Copyright (c) 2005-2014 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id: File.php 269 2014-04-25 23:29:54Z timoreithde $
 */
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!array_key_exists($type, $this->_loaders)) {
            ...
            $loader = new IfwPsn_Vendor_Zend_Loader_PluginLoader(array(
                'IfwPsn_Vendor_Zend_File_Transfer_Adapter' => IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/File/Transfer/Adapter/',
            ));
