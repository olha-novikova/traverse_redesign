 ...
 * @version    $Id: HelperBroker.php 269 2014-04-25 23:29:54Z timoreithde $
 */
    ...
    public static function getPluginLoader()
    {
        if (null === self::$_pluginLoader) {
            ...
            self::$_pluginLoader = new IfwPsn_Vendor_Zend_Loader_PluginLoader(array(
                'IfwPsn_Vendor_Zend_Controller_Action_Helper' => IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Controller/Action/Helper/',
            ));
        }
