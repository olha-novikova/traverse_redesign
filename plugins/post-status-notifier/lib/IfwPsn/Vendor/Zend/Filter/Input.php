 ...
 * @version    $Id: Input.php 269 2014-04-25 23:29:54Z timoreithde $
 */
        ...
        if (!isset($this->_loaders[$type])) {
            switch ($type) {
                case self::FILTER:
                    ...
                    $pathSegment   = IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Filter/';
                    break;
                case self::VALIDATE:
                    $prefixSegment = 'IfwPsn_Vendor_Zend_Validate_';
                    $pathSegment   = IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Validate/';
                    break;
                default:
                    require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Filter/Exception.php';
