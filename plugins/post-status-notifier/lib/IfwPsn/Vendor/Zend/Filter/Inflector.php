 ...
 * @version    $Id: Inflector.php 269 2014-04-25 23:29:54Z timoreithde $
 */
...
class IfwPsn_Vendor_Zend_Filter_Inflector implements IfwPsn_Vendor_Zend_Filter_Interface
{
    ...
    public function getPluginLoader()
    {
        if (!$this->_pluginLoader instanceof IfwPsn_Vendor_Zend_Loader_PluginLoader_Interface) {
            $this->_pluginLoader = new IfwPsn_Vendor_Zend_Loader_PluginLoader(array('IfwPsn_Vendor_Zend_Filter_' => IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Filter/'), __CLASS__);
        }
