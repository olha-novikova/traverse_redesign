...
class IfwPsn_Vendor_Twig_Parser implements IfwPsn_Vendor_Twig_ParserInterface
{
    ...
    public function parse(IfwPsn_Vendor_Twig_TokenStream $stream, $test = null, $dropNeedle = false)
    {
        ...
        if (null === $this->expressionParser) {
            $this->expressionParser = new IfwPsn_Vendor_Twig_ExpressionParser($this, $this->env->getUnaryOperators(), $this->env->getBinaryOperators());
        }
        ...
        $node = new IfwPsn_Vendor_Twig_Node_Module(new IfwPsn_Vendor_Twig_Node_Body(array($body)), $this->parent, new IfwPsn_Vendor_Twig_Node($this->blocks), new IfwPsn_Vendor_Twig_Node($this->macros), new IfwPsn_Vendor_Twig_Node($this->traits), $this->embeddedTemplates, $this->getFilename());
        ...
        while (!$this->stream->isEOF()) {
            switch ($this->getCurrentToken()->getType()) {
                ...
                case IfwPsn_Vendor_Twig_Token::BLOCK_START_TYPE:
                    ...
                    if ($token->getType() !== IfwPsn_Vendor_Twig_Token::NAME_TYPE) {
                        throw new IfwPsn_Vendor_Twig_Error_Syntax('A block must start with a tag name', $token->getLine(), $this->getFilename());
                    }
                    ...
                    if (null !== $test && call_user_func($test, $token)) {
                        ...
                        return new IfwPsn_Vendor_Twig_Node($rv, array(), $lineno);
                    }
                    ...
                    if (null === $subparser) {
                        if (null !== $test) {
                            ...
                            throw new IfwPsn_Vendor_Twig_Error_Syntax($error, $token->getLine(), $this->getFilename());
                        }
                        ...
                        throw new IfwPsn_Vendor_Twig_Error_Syntax($message, $token->getLine(), $this->getFilename());
                    }
                ...
                default:
                    throw new IfwPsn_Vendor_Twig_Error_Syntax('Lexer or parser ended up in unsupported state.', 0, $this->getFilename());
            }
        }
    ...
    {
        $this->blocks[$name] = new IfwPsn_Vendor_Twig_Node_Body(array($value), array(), $value->getLine());
    }
    ...
    public function setMacro($name, IfwPsn_Vendor_Twig_Node_Macro $node)
    {
        ...
        if (in_array($name, $this->reservedMacroNames)) {
            throw new IfwPsn_Vendor_Twig_Error_Syntax(sprintf('"%s" cannot be used as a macro name as it is a reserved keyword', $name), $node->getLine(), $this->getFilename());
        }
     ...
     *
     * @return IfwPsn_Vendor_Twig_ExpressionParser The expression parser
     */
     ...
     *
     * @return IfwPsn_Vendor_Twig_TokenStream The token stream
     */
     ...
     *
     * @return IfwPsn_Vendor_Twig_Token The current token
     */
