...
require(dirname(__FILE__) . '/Util/LoggerInterface.php');
require(dirname(__FILE__) . '/Util/DefaultLogger.php');
...
require(dirname(__FILE__) . '/Error/Permission.php');
require(dirname(__FILE__) . '/Error/RateLimit.php');
require(dirname(__FILE__) . '/Error/SignatureVerification.php');
...
require(dirname(__FILE__) . '/ApplePayDomain.php');
...
require(dirname(__FILE__) . '/SubscriptionItem.php');
...
require(dirname(__FILE__) . '/Webhook.php');
require(dirname(__FILE__) . '/WebhookSignature.php');
