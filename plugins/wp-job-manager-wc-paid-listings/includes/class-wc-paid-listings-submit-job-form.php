...
class WP_Job_Manager_WCPL_Submit_Job_Form {
	...
	public static function choose_package( $atts = array() ) {
		...
		$button_text   = 'before' !== get_option( 'job_manager_paid_listings_flow' ) ? __( 'Submit &rarr;', 'wp-job-manager-wc-paid-listings' ) : __( 'now add more details  &rarr;', 'wp-job-manager-wc-paid-listings' );
		?>
