...
// Define constants
define( 'JOB_MANAGER_WCPL_VERSION', '2.7.2' );
...
function wp_job_manager_wcpl_init() {
	...
	class WC_Paid_Listings {
		...
		public function __construct() {
			if ( ! defined( 'JOB_MANAGER_VERSION' ) || version_compare( JOB_MANAGER_VERSION, '1.24.0', '<' ) ) {
			...
			// Includes
			include_once( 'includes/class-wc-paid-listings-package-product.php' );
			...
			if ( class_exists( 'WC_Product_Subscription' ) ) {
				include_once( 'includes/class-wc-paid-listings-subscription-product.php' );
