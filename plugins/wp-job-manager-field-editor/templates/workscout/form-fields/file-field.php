...
?>
    ...
    <div  class="upload-btn"><i class="fa fa-upload"></i> <?php _e('Browse','workscout', 'wp-job-manager-field-editor'); ?></div>
</label>

<?php
	// WorkScout Ajax Not Enabled
	} else {
?>
